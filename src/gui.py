...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.grid_rowconfigure(1, weight=1) # Transcrição
        self.grid_rowconfigure(3, weight=2) # Resultados

        # --- FRAME DE SETUP ---
        setup_frame = ctk.CTkFrame(self)
        setup_frame.grid(row=0, column=0, padx=20, pady=10, sticky="ew")
        ...
        # --- FRAME DE GERAÇÃO (COM 3 BOTÕES) ---
        generation_frame = ctk.CTkFrame(self)
        generation_frame.grid(row=2, column=0, padx=20, pady=10, sticky="ew")
        ...
        # --- FRAME DE RESULTADOS (COM ABAS) ---
        self.tab_view = ctk.CTkTabview(self)
        self.tab_view.grid(row=3, column=0, padx=20, pady=10, sticky="nsew")
    ...
    def add_documents(self):
        filepaths = filedialog.askopenfilenames(title="Selecione os documentos de apoio")
        if filepaths:
    ...
    # --- Funções de Threading e Lógica para o Novo Fluxo ---
    ...
    def run_analysis_process(self):
        ...
        self.current_prompt_lovable = prompt_lovable # Salva o prompt para depois
