...
# Mapeia extensões de arquivo para as classes de loader apropriadas
LOADER_MAPPING = {
    ".pdf": PyPDFLoader,
    ".txt": TextLoader,
    ".md": TextLoader,
...
def get_text_from_file(file_path: str) -> str:
    ...
    try:
        ...
        # Tratamos os arquivos de texto explicitamente para definir a codificação
        if ext in [".txt", ".md", ".mdx"]:
            loader = TextLoader(file_path, encoding='utf-8')
        elif ext == ".pdf":
            loader = PyPDFLoader(file_path)
        else:
            # Loader genérico para outros tipos de arquivo
